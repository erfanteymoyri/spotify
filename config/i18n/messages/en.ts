export const messages = {
  ...
  auth: {
    ...
    resetFailed: "Failed to send recovery code",
    codeSentHint:
      "If an account exists for {email}, a 6-digit code has been sent there. It is valid for 15 minutes.",
    recoveryCode: "Recovery code",
    verifyCode: "Verify code",
    invalidCode: "This code is incorrect or has expired",
    resetExpired: "This recovery has expired. Please request a new code.",
    tooManyAttempts: "Too many attempts. Please try again later.",
    resendCode: "Send the code again",
    resendCodeIn: "Send the code again in {seconds}s",
    chooseNewPasswordHint: "Choose a new password for your account.",
    newPassword: "New password",
    setNewPassword: "Set new password",
    resetPasswordFailed: "Failed to set the new password",
